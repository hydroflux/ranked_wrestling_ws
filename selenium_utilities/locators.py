...
def locate_element_by_id(locator, id, type, clickable=False):
    try:
        if clickable:
...
def locate_element_by_class_name(locator, class_name, type, clickable=False):
    try:
        if clickable:
...
def locate_element_by_tag_name(locator, tag_name, type, clickable=False):
    try:
        if clickable:
...
def locate_elements_by_tag_name(locator, tag_name, type, clickable=False):
    try:
        if clickable:
